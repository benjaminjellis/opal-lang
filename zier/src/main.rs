...
pub(crate) const MANIFEST_NAME: &str = "zier.toml";
...
pub(crate) const BIN_ENTRY_POINT: &str = "main.zier";
pub(crate) const LIB_ROOT: &str = "lib.zier";
const VERSION: &str = env!("CARGO_PKG_VERSION");

// TODO: cargo calls them crates, what are they for zier?
...
#[command(about = "build tool for the zier programming language")]
struct Cli {
    #[command(subcommand)]
    command: Commands,
}
