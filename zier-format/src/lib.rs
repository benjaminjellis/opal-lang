//! Zier source code formatter.
//!
//! Uses the Wadler-Lindig pretty-printing algorithm to format Zier source.
//!
//! # Example
//! ```
//! let src = "(let add {a b} (+ a b))";
//! let formatted = zier_format::format(src, 80);
//! ```
...
/// Format Zier source code with the given line `width`.
///
